...
export const DICT: Dict = {
  ...
  "status.no_show": { fr: "Absent", ar: "لم يحضر" },
  "cal.clickslot": { fr: "Cliquez pour placer un rendez-vous", ar: "انقر لإضافة موعد" },
  "cal.conflict": { fr: "Ce créneau est déjà occupé", ar: "هذا الموعد محجوز بالفعل" },
  ...
  "patient.edit": { fr: "Modifier la fiche", ar: "تعديل الملف" },
  "pricing.title": { fr: "Un prix simple, en dirhams", ar: "سعر بسيط، بالدرهم" },
  "pricing.popular": { fr: "Populaire", ar: "الأكثر اختيارًا" },
  "pricing.permonth": { fr: "MAD / mois", ar: "درهم / شهريًا" },
  "pricing.onquote": { fr: "Sur devis", ar: "حسب الطلب" },
  "pricing.talk": { fr: "Parlons-en", ar: "لنتحدث" },
  "pricing.solo.name": { fr: "Solo", ar: "فردي" },
  "pricing.solo.desc": { fr: "Cabinet à un praticien", ar: "عيادة بطبيب واحد" },
  "pricing.solo.f1": { fr: "Agenda & rappels", ar: "المواعيد والتذكيرات" },
  "pricing.solo.f2": { fr: "Dossiers patients", ar: "ملفات المرضى" },
  "pricing.solo.f3": { fr: "Devis & paiements", ar: "الفواتير والمدفوعات" },
  "pricing.solo.f4": { fr: "1 utilisateur", ar: "مستخدم واحد" },
  "pricing.cabinet.name": { fr: "Cabinet", ar: "عيادة" },
  "pricing.cabinet.desc": { fr: "Le choix des cabinets qui grandissent", ar: "خيار العيادات التي تتوسّع" },
  "pricing.cabinet.f1": { fr: "Tout Solo, plus :", ar: "كل ما في «فردي»، بالإضافة إلى:" },
  "pricing.cabinet.f2": { fr: "Coffre d’imagerie", ar: "خزنة التصوير" },
  "pricing.cabinet.f3": { fr: "Comptes famille & rappels", ar: "حسابات العائلة والتذكيرات" },
  "pricing.cabinet.f4": { fr: "Analytique complète", ar: "تحليلات كاملة" },
  "pricing.cabinet.f5": { fr: "Jusqu’à 6 utilisateurs", ar: "حتى 6 مستخدمين" },
  "pricing.groupe.name": { fr: "Groupe", ar: "مجموعة" },
  "pricing.groupe.desc": { fr: "Plusieurs sites & spécialités", ar: "عدة مواقع وتخصصات" },
  "pricing.groupe.f1": { fr: "Tout Cabinet, plus :", ar: "كل ما في «عيادة»، بالإضافة إلى:" },
  "pricing.groupe.f2": { fr: "Multi-cabinets", ar: "عيادات متعددة" },
  "pricing.groupe.f3": { fr: "Intégrations AMO", ar: "ربط مع التأمين الإجباري" },
  "pricing.groupe.f4": { fr: "Support prioritaire", ar: "دعم ذو أولوية" },
  "chip.reminder": { fr: "Rappel WhatsApp", ar: "تذكير واتساب" },
  "chip.reminder.sub": { fr: "Envoyé ✓ · 11:30", ar: "أُرسل ✓ · 11:30" },
  "chip.payment": { fr: "Paiement enregistré", ar: "دفعة مسجَّلة" },
  "chip.payment.sub": { fr: "3 800 MAD · Carte", ar: "3 800 درهم · بطاقة" },
  "chip.devis": { fr: "Devis accepté", ar: "فاتورة مقبولة" },
  "chip.devis.sub": { fr: "Youssef B. · Implant", ar: "يوسف ب. · زرعة" },
  "treat.search": { fr: "Rechercher un patient, un acte, une dent…", ar: "ابحث عن مريض أو إجراء أو سن…" },
  "treat.nomatch": { fr: "Aucun devis ne correspond à cette recherche.", ar: "لا توجد فاتورة تطابق هذا البحث." },
  "treat.kpi.accepted": { fr: "Devis signés", ar: "فواتير موقَّعة" },
  "treat.kpi.pending": { fr: "En attente de réponse", ar: "بانتظار الرد" },
  "treat.actions": { fr: "Actions", ar: "إجراءات" },
  "treat.openfile": { fr: "Ouvrir le dossier", ar: "فتح الملف" },
  "treat.delete": { fr: "Supprimer le devis", ar: "حذف الفاتورة" },
  "treat.deleted": { fr: "Devis supprimé", ar: "تم حذف الفاتورة" },
  "plan.ready": { fr: "Devis prêt", ar: "الفاتورة جاهزة" },
  "analytics.days": { fr: "jours", ar: "يوم" },
  "analytics.year": { fr: "12 mois", ar: "12 شهرًا" },
  "analytics.export": { fr: "Exporter", ar: "تصدير" },
  "analytics.entries": { fr: "encaissements", ar: "عملية تحصيل" },
  "analytics.revenue": { fr: "Encaissé sur la période", ar: "المحصَّل خلال الفترة" },
  "analytics.basket": { fr: "Panier moyen", ar: "متوسط السلة" },
  "analytics.seen": { fr: "Patients vus", ar: "المرضى المستقبَلون" },
  "analytics.weekload": { fr: "Charge des 7 derniers jours", ar: "حجم العمل في آخر 7 أيام" },
  "analytics.appts": { fr: "RDV", ar: "موعد" },
  "analytics.topacts": { fr: "Actes les plus rentables", ar: "الأعمال الأكثر مردودية" },
  "analytics.plans": { fr: "Devis et patientèle", ar: "الفواتير التقديرية والمرضى" },
  "analytics.nodata": { fr: "Aucune donnée sur cette période.", ar: "لا توجد بيانات في هذه الفترة." },
  "nav.menu": { fr: "Menu", ar: "القائمة" },
  "nav.contact": { fr: "Contact", ar: "اتصل بنا" },
  "contact.kicker": { fr: "Parlons de votre cabinet", ar: "لنتحدث عن عيادتك" },
  "contact.title": { fr: "Une démonstration chez vous, en 20 minutes", ar: "عرض توضيحي في عيادتك خلال 20 دقيقة" },
  "contact.sub": {
    fr: "Dites-nous comment vous travaillez aujourd’hui : on vous montre ce que ça donne avec vos propres actes et vos tarifs.",
    ar: "أخبرنا كيف تعمل اليوم: نعرض لك النتيجة بأعمالك وأسعارك أنت.",
  },
  "contact.whatsapp": { fr: "WhatsApp", ar: "واتساب" },
  "contact.phone": { fr: "Téléphone", ar: "الهاتف" },
  "contact.email": { fr: "E-mail", ar: "البريد الإلكتروني" },
  "contact.reach": { fr: "Nous joindre", ar: "تواصل معنا" },
  "contact.wa.tmpl": {
    fr: "Bonjour, je gère un cabinet dentaire et je souhaite une démonstration de Dental Clinic OS.",
    ar: "مرحبًا، أدير عيادة أسنان وأرغب في عرض توضيحي لـ Dental Clinic OS.",
  },
  "contact.mail.subject": { fr: "Démonstration Dental Clinic OS", ar: "عرض توضيحي Dental Clinic OS" },
  "notif.title": { fr: "À traiter", ar: "للمعالجة" },
  "notif.empty": { fr: "Rien à signaler. Tout est à jour.", ar: "لا جديد. كل شيء محدَّث." },
  "notif.unconfirmed": { fr: "Présence à confirmer", ar: "حضور بانتظار التأكيد" },
  "notif.recall": { fr: "Rappel à envoyer", ar: "تذكير للإرسال" },
  "notif.unpaid": { fr: "Solde important", ar: "رصيد مرتفع" },
  "notif.dismiss": { fr: "Masquer", ar: "إخفاء" },
  "patient.updated": { fr: "Fiche mise à jour", ar: "تم تحديث الملف" },
  "pay.empty": { fr: "Aucun paiement enregistré pour ce patient.", ar: "لا توجد مدفوعات مسجلة لهذا المريض." },
  "family.empty": { fr: "Aucun proche rattaché à ce dossier.", ar: "لا يوجد أقارب مرتبطون بهذا الملف." },
  "plan.empty": { fr: "Aucun devis pour ce patient.", ar: "لا توجد فاتورة تقديرية لهذا المريض." },
  ...
  // Le devis est téléchargé et classé au dossier ; rien n'est expédié. Annoncer
  // « envoyé au patient » faisait croire à un envoi qui n'a jamais lieu.
  "plan.sent": { fr: "Devis téléchargé et classé au dossier", ar: "تم تنزيل الفاتورة وحفظها في الملف" },
